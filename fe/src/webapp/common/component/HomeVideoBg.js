...
const HomeVideoBg = () => {
    ...
    const checkLogin = () => {
        console.log('-==ewafdafds====asfda=dsf=asdf====adsfadf=adsfafdafda=====');
    ...
    return (
        <Loader>
            ...
            <WhatWeDoOne tagline="What We Do" title="Digital Services" image={imgWhatWeDo} classes="no-bottom-line">
            ...
            <PortfolioOne tagline="Show Your Works" title="Our Portfolio" dashColor="dark" data={dataPortfolio} filter={true} categories={['Branding', 'Creative Design', 'Web Design', 'Stationery', 'Photography']} />
            <TestimonialsOne data={dataTestimonials} />
            <TeamOne tagline="Meet Creatives" title="Our Team" data={dataTeam} />
            <ParallaxOne image={imgParallax}>Where something special happens every days</ParallaxOne>
            <PricingsOne tagline="Select Your Plan" title="Our Pricing" data={dataPricings} dashColor="dark" />
            <ContactOne title='Request a Quote <span class="text-bottom-line-sm">Now</span>' tagline="Contact Us" />
