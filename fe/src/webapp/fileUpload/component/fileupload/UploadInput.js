...
const UploadInput = ({ cref, getUploadedFiles, fileParam = [] }) => {
    ...
    const uploadAjax = useCallback((e) => {
        ...
        axios.post('http://localhost:8080/uploadAjax', formData, { headers: { 'Content-Type': 'multipart/form-data' } }).then((res) => {
            console.log(res);
    ...
    return (
        <div>
            <Button variant="contained" component="label">
                ...
                <input id={'file-input'} style={{ display: 'none' }} type="file" name="imageFile" onChange={uploadAjax} multiple={true} />
            </Button>
            <div>
                <ul>
