...
const register = (fd) => {
    ...
    return axios
        .post(`${SERVER}/reviews/register`, fd, {
            headers: {
...
const list = (pageResult) => {
    ...
    const str = 'page=' + (!pageResult.page ? 1 : pageResult.page) + '&type=' + (pageResult.type ? pageResult.type : '') + '&keyword=' + (pageResult.keyword ? pageResult.keyword : '');
