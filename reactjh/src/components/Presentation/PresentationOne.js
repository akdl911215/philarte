...
const PresentationOne = ({ title, text, textBtn, pathBtn }) => (
    <section style={{ background: `url(${img}) center center no-repeat #e6f8f9` }} className="height-600px">
        <div className="container">
            <div className="row">
                <div className="col-md-8 text-left">
                    <h1 className="font-700 xs-font-40px font-40px">{title && parse(title)}</h1>
