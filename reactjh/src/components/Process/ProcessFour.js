...
import imgPlanetLeft from '../../assets/images/planet-x-left.png';
import imgPlanetRight from '../../assets/images/planet-x-right.png';
    ...
    <>
        <div className="planet-x-wrap">
            ...
            <div className="planet-x-right">
                <img src={imgPlanetRight} className="img-responsive" alt="planet-right" />
            </div>
        </div>
        <section style={{ background: `url(${bg}) center center no-repeat #24182e` }}>
            <div className="container">
                <div className="row">
                    <div className="col-md-6 col-sm-6 col-xs-12 xs-mb-50">
                        <div className="section-title text-left white-color">
                            <h2 className="cardo-font white-color" data-backfont={backfont || 'Steps'}>
                                {tagline}
                            </h2>
                ...
                <div className="row our-process-style-02 mt-50">
                    {data.map((service, i) => (
                        <div key={service.id} className="col-md-3 col-sm-6 col-xs-12 line xs-mb-30 sm-mb-30">
