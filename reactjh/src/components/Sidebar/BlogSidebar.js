...
import imgAbout from '../../assets/images/about-me.jpg';
...
const BlogSidebar = () => (
    <div className="col-md-3 col-sm-3 col-xs-12">
        ...
        <div className="mb-50">
            ...
            <p className="mt-30">Lorem ipsum dolor sit amet consectetur adipiscing elit. Sed dui lorem adipiscing in adipiscing et.</p>
