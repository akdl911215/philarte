...
const TeamFour = ({ tagline, title, children, data }) => (
    <>
        ...
        <section style={{ background: `url(${imgBg}) center center no-repeat #24182e` }} id="team">
                ...
                <div className="row">
                    <div className="col-md-4 col-sm-4 col-xs-12 xs-mb-50">
                        <div className="section-title text-left">
                            ...
                            <p className="mt-50 font-26px line-height-40 white-color">{children && parse(children)}</p>
                        </div>
                    </div>
                                ...
                                <div key={member.id} className={'col-md-6 col-sm-6 col-xs-12 ' + member.classes}>
                                    <div className="team-member">
                                        <div className="team-thumb">
                                            ...
                                            <img src={require('../../assets/images/' + member.image)} alt={member.title} />
