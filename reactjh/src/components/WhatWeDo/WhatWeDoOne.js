...
const WhatWeDoOne = ({ tagline, title, backfont, image, textBtn, children, classes }) => (
    // Digital Service 어두운 사각형 부분 READ MORE 부분 // TestimonialsTwo 와 겹침
    <section className={'dark-bg lg-section ' + classes} id="about">
        <div className="col-md-6 col-sm-4 bg-flex bg-flex-right">
            <div className="bg-flex-holder bg-flex-cover" style={{ backgroundImage: `url(${image})` }}></div>
        </div>
        <div className="container-fluid">
            <div className="col-md-5 col-sm-7 pl-70 pr-70">
                ...
                <p className="mt-30">
                    <a href="!#" className="btn btn-lg btn-light-outline btn-square">
                        {textBtn || 'Read More'}
                    </a>
                </p>
            </div>
