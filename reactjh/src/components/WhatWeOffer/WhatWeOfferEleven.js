...
const WhatWeOfferEleven = ({ data, tagline, title, text, backfont, textImg, image, imageAlt }) => (
    // 메인비디오 영상 밑에 Storytellers, Award Winning, Grow Business 등 하늘색 영역
    <section id="feature">
            ...
            <div className="row mt-100 xs-mt-50">
                <div className="col-md-6 col-sm-6">
                    <div className="section-title pt-100 xs-pt-50">
                        <h2 className="cardo-font default-color" data-backfont={backfont || 'Skills'}>
                            {tagline}
                        </h2>
