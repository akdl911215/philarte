        ...
        <div className="container">
            ...
            <div className="row mt-50">
                ...
                <div className="col-md-6 col-sm-6 col-xs-12 col-md-offset-1 mt-50">
                    <h2 className="cardo-font mt-0">We are offer fully digital services</h2>
                    <p className="mt-30 font-16px">Wisi minimum vituperatoribus his in. Tation iriure impetus vim ut. An cum dicat minim accusata, sea enim labore mnesarchum et, ex justo libris feugiat eam sea id iisque sapientem assum nonumes et ius, error soleat cu ius dicant nusquam ad, et ius iriure molestiae qui ex, et dignissim</p>
            ...
            <div className="row mt-80">
                {data.map((service, i) => (
                    <div key={service.id} className="col-md-4 col-sm-4 col-xs-12">
                        <h3 data-backfont={'0' + (i + 1)} className="cardo-font default-color font-italic">
                            {service.tagline}
                        </h3>
