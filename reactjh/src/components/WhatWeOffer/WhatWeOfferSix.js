...
const WhatWeOfferSix = ({ tagline, title, backfont, text, textBtn, pathBtn, data }) => (
    <section id="feature">
                        ...
                        {data.map((service, i) => (
                            <div key={service.id} className="panel">
                                <div className="panel-heading">
                                    <a data-toggle="collapse" data-parent="#accordion-style" href={'#question' + i} aria-expanded="false" className="collapsed">
                                ...
                                <div id={'question' + i} className={'panel-collapse collapse ' + (i === 0 ? 'in' : '')} aria-expanded="false" role="tablist">
